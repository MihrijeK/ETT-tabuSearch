...
public class JSONUtils {
	...
	public static <T> T convert(String json, TypeReference<T> typeReference) {
			...
			try {
				// faji osht te type reference...
				// System.out.println(json); //kjo osht ok 
				// System.out.println(mapper.writerWithDefaultPrettyPrinter().writeValueAsString(typeReference));
